 ...
 */
public class ConcesionarioForm extends javax.swing.JFrame {

    /**
     * Creates new form ConcesionarioForm
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        IniciarSesionForm s = new IniciarSesionForm();
        s.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        SolicitarCitaForm s = new SolicitarCitaForm();
        s.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConcesionarioForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConcesionarioForm().setVisible(true);
            }
        });
    }
